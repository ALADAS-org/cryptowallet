## Cryptowallet 0.4.0
![](https://github.com/ALADAS-org/cryptowallet/blob/master/_doc/Screenshots/Entropy_Wallet_0_4_0_EN.gif)
1. Purpose  
   ...
   NB: _Cryptowallet_ uses [ElectronJS](https://www.electronjs.org/) as well as many modern and popular
...
2. Setup 
   + 2.1. _Fast and Furious_ (advised for end users)
      + 2.1.1. Download [Cryptowallet installer](https://sourceforge.net/projects/aladas-cryptowallet/files/latest/download)
   ...
   + 2.2. _Wizard's Lair_ (advised for custom local setup and/or software developers)
	  ...
	  + 2.2.3. Import _Cryptowallet_ from _github_
	      * Open the [Cryptowallet repository](https://github.com/ALADAS-org/cryptowallet) 
	      * Use the [<> Code v] green button
	      * Copy the displayed [.git URL](https://github.com/ALADAS-org/cryptowallet.git)
...
3. Release notes
    ...
    + 3.10. Features in `0.3.4`
	    * Added _password feature_ for `HD Wallet` (see 4.1.5)
		* `Seed` tab renamed to `Entropy`
		* Bug fix: crash when saving `SWORD Wallet`
		* Update of [`Cryptowallet installer`](https://sourceforge.net/projects/aladas-cryptowallet/) on [`SourceForge`](https://sourceforge.net/)
...
4. _Cryptowallet_ User Guide  
    ...
    + 4.1. Features 
        * 4.1.1. _Cryptowallet Standalone installer_    
		    + 4.1.1.a: Downloadlc [Cryptowallet installer](https://sourceforge.net/projects/aladas-cryptowallet/files/latest/download)
